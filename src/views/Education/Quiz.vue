          ...
          <section class="py-5 text-center container top_section">
              <div class="row py-lg-5">
                  <div class="col-lg-6 col-md-8 mx-auto">
                      ...
                      <p class="lead text-muted">Challenge yourself with quizzes on recycling and upcycling. Earn points by testing your knowledge!</p>
                      <p>
                          <a href="educational_hub.html" class="btn btn-primary my-2">Watch Educational Videos</a>
                      ...
                      <div class="container-fluid">
                          ...
                          <div class="collapse navbar-collapse" id="navbarSupportedContent">
                              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                  <li class="nav-item">
                                      <a class="nav-link" href="#" @click.prevent="activeFilter = 'all'">All</a>
                                  </li>
                                  <li class="nav-item">
                                      <a class="nav-link" href="#" @click.prevent="activeFilter = 'recycling'">Recycle</a>
                                  </li>
                                  <li class="nav-item">
                                      <a class="nav-link" href="#" @click.prevent="activeFilter = 'upcycling'">Upcycle</a>
                                  </li>
                              </ul>
                              ...
                              <div class="card">
                                  <div class="card-body">
                                      ...
                                      <div v-if="quizAttempts[quiz.id]" class="mb-3">
                                          ...
                                          <!-- New message displayed if the quiz is completed with full marks -->
                                          <p v-if="quizAttempts[quiz.id].completed" class="text-warning mt-2">You can no longer gain points from completing this quiz</p>
                                      </div>
  ...
  },
  {
    ...
    function submitQuiz() {
      ...
      if (quizAttempts[quizId]) {
        ...
        quizAttempts[quizId] = { attempts: 1, score: score };
      }
