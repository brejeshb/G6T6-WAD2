<template>
    <div class="border rounded-5 w-100 h-100 p-1 p-md-3 p-lg-5 p-xl-5 bento" style="min-height: 600px">
        <!-- Change min-height so at iphone level will make div bigger-->
        <h1>Recycle, Visualise, Flaunt </h1>
        <div style="align-items: center;align-content: center;justify-content: center;height: 85%;">
            <!-- Adjust height attr to make icons be at the center -->
