    ...
    <div class="container-fluid p-lg-5 p-0 h-100 scroll-section"
        ...
        <div class="container p-5 text-center rounded-5 box"
            ...
            <div class="text-start fw-bold">
                ...
                <br>
                <div class="container p-4 ps-0 pe-0">
                    <div class="row">
                        <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                            <div class="rounded-5 bg-white p-5 h-100 fw-bold">
                                <h2 style="font-weight: bolder;" class="metric">&uparrow; 1.9%</h2>
                                Global GHG Increment YoY
                        ...
                        <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                            <div class="rounded-5 bg-white p-5 h-100 fw-bold">
                                <h2 style="font-weight: bolder;" class="metric">&uparrow; 20.0% </h2>
                        ...
                        <div class="col-lg-4 col-12 mb-5 mb-lg-0">
                            <div class="rounded-5 bg-white p-5 h-100 fw-bold">
                                <h2 style="font-weight: bolder;" class="metric">&uparrow; 3.7mm</h2>
                                Sea Level Rise Per Annum
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container p-5 text-center rounded-5 box" style="background-color: #F3F4F6;height: 80vh">
            ...
            <br><br><br>
            <div class="container1 p-5" style="height: 40%">
                <div class="tree">
        ...
        <div class="container p-5 text-center rounded-5 box" style="background-color: #F3F4F6;height: 80vh;">
            ...
            <div class="container1">
                <div class="tree">
                    <div class="branch1" style="--x:0">
                        <span class="dead" style="--i:0;"></span>
                        <span class="dead" style="--i:1;"></span>
                        <span class="dead" style="--i:2;"></span>
                        <span class="dead" style="--i:3;"></span>
                    </div>
                    <div class="branch" style="--x:1">
                        <span class="dead" style="--i:0;"></span>
                        <span class="dead" style="--i:1;"></span>
        ...
        <!-- Recycle Lah-->
        <div class="container p-5 text-center rounded-5 box" style="background-color: #F3F4F6;height: min-content;">
            <div class="text-center">
                <h1 style="font-weight: bold;color: #788645;">Become an Eco Warrior Lah</h1><br>
                <h3 style="font-weight: bold;">
...
.box {
    ...
    /* Adjust this based on the offset */
...
.tree {
    ...
    animation: treeAnimate 4s linear infinite;
}
...
.tree div.branch .dead {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
    height: 100%;
    background: linear-gradient(90deg, #741f1f, #ba890d);
    clip-path: polygon(50% 0%, 0% 100%, 100% 100%);
    border-bottom: 5px solid #00000019;
    transform-origin: bottom;
    transform: rotateY(calc(90deg * var(--i))) rotateX(30deg) translateZ(28.5px);
